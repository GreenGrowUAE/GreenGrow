                ...
                <div class="container">
                    <div class="row align-items-start">
                        <div class="col-6 dpbackground">
                            <div class="row">
                                <img class="" src="/images/prod2.png" height="600px"/>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col-12 align-self-center">
                                        <h1>Tablet Fertilizer - 2.5KG</h1>
                                    </div>
                                    <div class="col-12">
                                        <p>Introducing GreenGrow's tablet fertilizer, the innovative solution to simplify and optimize your plant care routine. With GreenGrow's tablet fertilizer, nurturing your plants has never been easier or more effective. These convenient tablets are meticulously crafted with a perfect blend of nutrients, ensuring that your plants receive the essential elements they need for optimal growth and vitality.</p>
                                    </div>

                                    <div class="col-12 price">
                                        <P>Price: <b>100.00 AED</b></p>
                                    </div>
                                    
                                    <div class="col-12 ppdesc">
                                        <p2 style="font-family: Inter">Weight: 2500g / 2.5kg</p2><br>
                                        <p3 style="font-family: Inter">Class: Tablet Fertiliser</p3><br><br>
                                    </div>
                                    <form method="POST">
                                        <input type="hidden" name="name" value="Tablet_Fertilizer-2.5KG">

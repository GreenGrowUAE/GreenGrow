                ...
                <div class="container">
                    <div class="row align-items-start">
                        <div class="col-6 dpbackground">
                            <div class="row">
                            <img class="" src="/images/spray.png" height="600px"/>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    <div class="col-12 align-self-center">
                                        <h1>Liquid Fertilizer - 2L</h1>
                                    </div>
                                    <div class="col-12">
                                        <p>Introducing GreenGrow's liquid fertilizer, the perfect solution to unlock the true potential of your plants. Specially formulated using advanced scientific techniques and a deep understanding of plant nutrition, GreenGrow's liquid fertilizer is a game-changer for all types of gardening endeavors. This concentrated formula is designed to deliver a powerful and balanced blend of essential nutrients directly to your plants' root systems, ensuring rapid absorption and maximum benefit.</p>
                                    </div>

                                    <div class="col-12 price">
                                        <P>Price: <b>35.00 AED</b></p>
                                    </div>
                                    
                                    <div class="col-12 ppdesc">
                                        <p2 style="font-family: Inter">Volume: 2000ml / 2L</p2><br>
                                        <p3 style="font-family: Inter">Class: Liquid Fertiliser</p3><br><br>
                                    </div>
                                    <form method="POST">
                                        <input type="hidden" name="name" value="Liquid_Fertilizer-2L">
            ...
            <div class="container text-center" id="carousel-partner">
                ...
                <div class="carousel partner-carousel" data-flickity='{ "autoplay": true, "wrapAround": true, "autoPlay": 3000, "pauseAutoPlayOnHover": true}'>
                    <div class="carousel-cell carousel-partner">
                        <!-- Pellet Fertilizer  -->
                        <a href="/pf2.php"><img src="/images/prod5.png" width="300px"></a>
                        <h1>Pellet Fertilizer</h1>
                        <p>5000g / 5kg</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Pellet Fertilizer  -->
                        <a href="/pf3.php"><img src="/images/prod5.png" width="300px"></a>
                        <h1>Pellet Fertilizer</h1>
                        <p>10000g / 10kg</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Tablet Fertilizer  -->
                        <a href="tf1.php"><img src="/images/prod3.png" width="300px"></a>
                        <h1>Tablet Fertilizer</h1>
                        <p>500g</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Tablet Fertilizer  -->
                        <a href="tf2.php"><img src="/images/prod3.png" width="300px"></a>
                        <h1>Tablet Fertilizer</h1>
                        <p>1000g / 1kg</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Tablet Fertilizer  -->
                        <a href="tf3.php"><img src="/images/prod2.png" width="300px"></a>
                        <h1>Tablet Fertilizer</h1>
                        <p>5000g / 5kg</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Liquid Fertilizer  -->
                        <a href="lf1.php"><img src="/images/spray.png" width="300px"></a>
                        <h1>Liquid Fertilizer</h1>
                        <p>1000ml / 1L</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Liquid Fertilizer  -->
                        <a href="lf2.php"><img src="/images/spray.png" width="300px"></a>
                        <h1>Liquid Fertilizer</h1>
                        <p>2000ml / 2L</p>
                    </div>
                </div>

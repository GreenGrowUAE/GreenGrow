                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 price">
                                        <P>Price: <b>20.00 AED</b></p>
                                    </div>
                                    
                                    <div class="col-12 ppdesc">
                                        <p2 style="font-family: Inter">Volume: 1000ml / 1L</p2><br>
                                        <p3 style="font-family: Inter">Class: Liquid Fertiliser</p3><br><br>
                                    </div>
                                    <form method="POST">
                                        <input type="hidden" name="name" value="Liquid_Fertilizer-1L">

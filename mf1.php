                ...
                <div class="container">
                    <div class="row align-items-start">
                        <div class="col-6 dpbackground">
                            <div class="row">
                                <img class="" src="/images/prod8.png" height="600px"/>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 price">
                                        <P>Price: <b>10.00 AED</b></p>
                                    </div>
                                    
                                    <div class="col-12 ppdesc">
                                        <p2 style="font-family: Inter">Weight: 15000g / 15kg</p2><br>
                                        <p3 style="font-family: Inter">Class: Manure Fertilizer</p3><br><br>
                                    </div>
                                    <form method="POST">
                                        <input type="hidden" name="name" value="Manure_Fertilizer-15KG">
            ...
            <div class="container text-center" id="carousel-partner">
                ...
                <div class="carousel partner-carousel" data-flickity='{ "autoplay": true, "wrapAround": true, "autoPlay": 3000, "pauseAutoPlayOnHover": true}'>
                    <div class="carousel-cell carousel-partner">
                        <!-- Manure Fertilizer  -->
                        <a href="/mf2.php"><img src="/images/prod8.png" width="300px"></a>
                        <h1>Manure Fertilizer - 25KG</h1>
                        <p>25000g / 25kg</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Manure Fertilizer  -->
                        <a href="/mf3.php"><img src="/images/prod8.png" width="300px"></a>
                        <h1>Manure Fertilizer</h1>
                        <p>50000g / 50kg</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                        <!-- Compost Fertilizer  -->
                        <a href="cs1.php"><img src="/images/prod3.png" width="300px"></a>
                        <h1>Compost</h1>
                        <p>25000g / 25L</p>
                    </div>
                    <div class="carousel-cell carousel-partner">
                    ...
                    <div class="carousel-cell carousel-partner">
                        <!-- Tablet Fertilizer  -->
                        <a href="cs3.php"><img src="/images/prod2.png" width="300px"></a>
                        <h1>Tablet Fertilizer</h1>
                        <p>100000g / 100L</p>
                    </div>
                    <div class="carousel-cell carousel-partner">

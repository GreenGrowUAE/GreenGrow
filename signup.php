...
<htm lang="eng">
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="/Group_Asssessment//css/layout2.css">
        <link rel="icon" href="/Group_Asssessment/images/icon_logo.png">
                    ...
                    <div class="container">
                        <form method="POST">
                            <div class="container" style="padding-left: 20%; padding-right: 20%;">
                                ...
                                <div class="col var">
                                    <input class="var_i" value="<?php echo $first_name ?>" name="first_name" type="text">
                                </div>
                                <div class="col var_text text-start">
                                    Last Name
                                </div>
                                <div class="col var">
                                    <input class="var_i" value="<?php echo $last_name ?>" name="last_name" type="text">
                                </div>
                                <div class="col var_text text-start">
                                    Email
                                </div>
                                ...
                                <div class="col var">
                                    <input class="var_i" name="password2" type="Password">
                                </div>

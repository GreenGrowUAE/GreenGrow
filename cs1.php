                ...
                <div class="container">
                    <div class="row align-items-start">
                        <div class="col-6 dpbackground">
                            <div class="row">
                                <img class="" src="/images/prod9.png" height="600px"/>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 price">
                                        <P>Price: <b>15.00 AED</b></p>
                                    </div>
                                    
                                    <div class="col-12 ppdesc">
                                        <p2 style="font-family: Inter">Weight: 25000g / 25l</p2><br>
                                        <p3 style="font-family: Inter">Class: Compost</p3><br><br>
                                    </div>
                                    <form method="POST">
                                        <input type="hidden" name="name" value="Compost-25L">
